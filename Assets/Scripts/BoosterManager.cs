...
public class BoosterManager : MonoBehaviour
{
	...
	void LoadData()
	{
		...
		m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 4].value = 1.4f;	m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 4].cost = 10000;
		m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 5].value = 1.5f;	m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 5].cost = 15000;
        m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 6].value = 1.6f;    m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 6].cost = 20000;
        m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 7].value = 1.7f;    m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 7].cost = 25000;
        m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 8].value = 1.8f;    m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 8].cost = 35000;
        m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 9].value = 1.9f;    m_uBoosters[(int)BOOSTERTYPE.ScoreMult, 9].cost = 50000;
		...
		m_uBoosters[(int)BOOSTERTYPE.GoldMult, 4].value = 1.4f;	m_uBoosters[(int)BOOSTERTYPE.GoldMult, 4].cost = 10000;
		m_uBoosters[(int)BOOSTERTYPE.GoldMult, 5].value = 1.5f;	m_uBoosters[(int)BOOSTERTYPE.GoldMult, 5].cost = 15000;
        m_uBoosters[(int)BOOSTERTYPE.GoldMult, 6].value = 1.6f; m_uBoosters[(int)BOOSTERTYPE.GoldMult, 6].cost = 20000;
        m_uBoosters[(int)BOOSTERTYPE.GoldMult, 7].value = 1.7f; m_uBoosters[(int)BOOSTERTYPE.GoldMult, 7].cost = 25000;
        m_uBoosters[(int)BOOSTERTYPE.GoldMult, 8].value = 1.8f; m_uBoosters[(int)BOOSTERTYPE.GoldMult, 8].cost = 35000;
        m_uBoosters[(int)BOOSTERTYPE.GoldMult, 9].value = 1.9f; m_uBoosters[(int)BOOSTERTYPE.GoldMult, 9].cost = 50000;
		...
		m_uBoosters[(int)BOOSTERTYPE.Shield, 4].value = 0.93f;	m_uBoosters[(int)BOOSTERTYPE.Shield, 4].cost = 10000;
		m_uBoosters[(int)BOOSTERTYPE.Shield, 5].value = 0.9f;	m_uBoosters[(int)BOOSTERTYPE.Shield, 5].cost = 15000;
        m_uBoosters[(int)BOOSTERTYPE.Shield, 6].value = 0.87f;  m_uBoosters[(int)BOOSTERTYPE.Shield, 6].cost = 20000;
        m_uBoosters[(int)BOOSTERTYPE.Shield, 7].value = 0.85f;  m_uBoosters[(int)BOOSTERTYPE.Shield, 7].cost = 25000;
        m_uBoosters[(int)BOOSTERTYPE.Shield, 8].value = 0.82f;  m_uBoosters[(int)BOOSTERTYPE.Shield, 8].cost = 35000;
        m_uBoosters[(int)BOOSTERTYPE.Shield, 9].value = 0.78f;  m_uBoosters[(int)BOOSTERTYPE.Shield, 9].cost = 50000;
		...
		m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 4].value = 0.93f;	m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 4].cost = 10000;
		m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 5].value = 0.9f;	m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 5].cost = 15000;
        m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 6].value = 0.87f;  m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 6].cost = 20000;
		m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 7].value = 0.85f;  m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 7].cost = 25000;
		m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 8].value = 0.82f;  m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 8].cost = 35000;
        m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 9].value = 0.78f;  m_uBoosters[(int)BOOSTERTYPE.SlowerGems, 9].cost = 50000;
		...
		m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 4].value = 1.05f;	m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 4].cost = 10000;
		m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 5].value = 1.07f;	m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 5].cost = 15000;
        m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 6].value = 1.1f;   m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 6].cost = 20000;
        m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 7].value = 1.12f;  m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 7].cost = 25000;
        m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 8].value = 1.14f;  m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 8].cost = 35000;
        m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 9].value = 1.17f;  m_uBoosters[(int)BOOSTERTYPE.BiggerGems, 9].cost = 50000;
