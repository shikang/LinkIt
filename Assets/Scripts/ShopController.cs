...
public class ShopController : MonoBehaviour
{
	...
	public void SetItems ()
	{
		...
		{
			m_ShopSlots[i].GetComponent<ShopMainMenu>().SetData( productTitle[i], (uint)InAppProcessor.Instance.ProductParamMap[p.Key].m_nProductParam, p.Value.m_sPrice, "Contains %d coins" );
			++i;
		}
